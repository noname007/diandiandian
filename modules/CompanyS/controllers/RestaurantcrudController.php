...
use app\modules\CompanyS\models\RestaurantSearch;
...
/**
 * RestrantcrudController implements the CRUD actions for Restaurant model.
 */
class RestaurantcrudController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $user = \Yii::$app->user;
        //['name', 'create_at', 'updated_at', 'address', 'user_id']
        $time = time();
